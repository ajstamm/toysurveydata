...
While functions can be used individually, the package is designed to allow you to build a settings table as described in the [Settings Table Design](https://ajstamm.github.io/toysurveydata/articles/settings_table.html) vignette, then run most functions on that table to generate the full dataset. 
