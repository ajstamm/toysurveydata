...
This function is not run using the settings table. It takes three inputs, start date, end date, and a number indicating the level of error (from 0 to 100 percent). The only variable returned is age. In the example below, all dates in our date example were from 2025, so all ages will be 25 unless we introduce error. 
